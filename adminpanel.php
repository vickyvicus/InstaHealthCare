     ...
     <div class="menu">
        ...
        <div class="query">
        	<div class="move">
        		<div class="doctor">
              <?php
					if(isset($_POST['Doc_name'])  && isset($_POST['type']) && isset($_POST['info'])  && isset($_POST['city']) && isset($_POST['Doc_email']) && isset($_POST['doc_contact']) && isset($_POST['address']) && isset($_POST['lat']) && isset($_POST['lng'])){
							...
							if(($extension =='jpg' || $extension == 'jpeg') && $size < $max_size && ($filetype=='image/jpg' || $filetype=='image/jpeg')){
								...
								if(file_exists($location.$Doc_name.$extension)){
								 ...
								 if($query_run = mysql_query($query)){
									 $query1 ="SELECT max(id) as id FROM `doctor`";
									$query_run1 = mysql_query($query1);
									$query_result1= mysql_fetch_array($query_run1,MYSQL_ASSOC);
									$query1 = "INSERT INTO `mp`.`doctors_clinic` (`doc_id`, `address`, `lat`,`lng`) VALUES (".$query_result1['id'].", '".$address."',".$lat.",".$lng.")";
									mysql_query($query1);
										 echo'<script type="text/javascript">
										$("document").ready(function(){
										slidedown();
		...
		<table border="0">
           ...
           <script type="text/javascript">
			...
			<tr>
            	<td>Address</td>
                <td><textarea type="text" name="address" class="FormElementtext" maxlength="500" required></textarea></td>
            </tr>
			...
			<tr>
    			...
    			<td><input type="text" name="lat" class="FormElement" required></td>
            </tr>
			
			<tr>
            	<td>Enter Longitute</td>
    			<td><input type="text" name="lng" class="FormElement" required></td>
            </tr>
